...
def muscle(time,gene):
    ...
    cmd = "C:\\Users\\12737\\Documents\\Capstone_project\\muscle5.1.win64.exe --align " + "{} -output {}".format(inputFileName, outputFileName)
    print(cmd)
...
def muscleAll(time):
    ...
    cmd = "F:\\Capstone_project\\muscle5.1.win64.exe --align " + "{} -output {}".format(inputFileName, outputFileName)
    print(cmd)
